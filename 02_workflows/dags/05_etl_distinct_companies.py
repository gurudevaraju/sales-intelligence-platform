"""Airflow ETL DAG: s3://<bucket>/cssip/distinct_companies.csv -> cyber.distinct_companies.
...
tell the same 6-step story every run:
    ...
    5. LOAD      -- overwrite cyber.distinct_companies (create-if-missing +
...
TABLE_NAME = "distinct_companies"
S3_KEY = "cssip/distinct_companies.csv"
...
@dag(
    dag_id="05_etl_distinct_companies",
...
def s3_to_rds_etl_distinct_companies():
    @task
    def extract() -> str:
...
s3_to_rds_etl_distinct_companies()
