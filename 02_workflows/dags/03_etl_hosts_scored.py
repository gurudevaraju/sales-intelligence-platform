"""Airflow ETL DAG: s3://<bucket>/cssip/hosts_scored.csv -> cyber.hosts_scored.
...
tell the same 6-step story every run:
    ...
    5. LOAD      -- overwrite cyber.hosts_scored (create-if-missing +
...
TABLE_NAME = "hosts_scored"
S3_KEY = "cssip/hosts_scored.csv"
...
def s3_to_rds_etl_hosts_scored():
    @task
    def extract() -> str:
